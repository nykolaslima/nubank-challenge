...
class SocialNetworkCalculatorTest extends UnitSpec {
  ...
  before {
    ...
    socialNetworkCalculator = new SocialNetworkCalculator(vertexDistanceCalculator = vertexDistanceCalculator, closenessCentralityCalculator = closenessCentralityCalculator)
  }
